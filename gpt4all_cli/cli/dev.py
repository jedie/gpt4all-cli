...
import gpt4all_cli
from gpt4all_cli import constants
...
def install():
    """
    Run pip-sync and install 'gpt4all_cli' via pip as editable.
    """
...
def fix_code_style(color: bool = True, verbose: bool = False):
    """
    Fix code style of all gpt4all_cli source code files via darker
    """
